...
enum {RTL_CANCELPENDING, RTL_CANCELTYPE, RTL_THREAD_JOINABLE, RTL_THREAD_FINISHED, RTL_THREAD_TIMERARMED, RTL_THREAD_WAIT_FOR_JOIN, RTL_THREAD_OK_TO_FINISH_JOIN
     ...
     , RTL_THREAD_SIGNAL_INTERRUMPIBLE
#endif
};
...
#define RTL_SIG_DFL 0
#define RTL_SIG_IGN 0
#endif
...
extern void rtl_reschedule_thread (pthread_t thread);
...
#ifdef CONFIG_OC_PSIGNALS
#define HIGHER_PRIORITY_THREAD(th1,th2) (RTL_PRIO(th1)>RTL_PRIO(th2))
#endif
